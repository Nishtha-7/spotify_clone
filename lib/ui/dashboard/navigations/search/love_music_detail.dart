...
import 'love_detail.dart';

class LoveMusicDetail extends StatefulWidget {
  String AlbumPicPath = "assets/images/1st row/bts bts.jpeg";

  LoveMusicDetail({required this.AlbumPicPath});

  @override
  State<LoveMusicDetail> createState() => _AlbumDetailsPageState();
}

class _AlbumDetailsPageState extends State<LoveMusicDetail> {
  late AudioPlayer _audioPlayer;

  int? currentlyPlayingIndex;
  bool isPlaying = false;

  final List<Song> weddingSongs  = [
    Song( imgPath: "assets/images/comfort/blue song.jpeg",
  name: "Blue",
  artist: "yung kai",
  audioPath: "assets/audio/songs/blue yung kai.mp3"),

  Song(imgPath: "assets/images/comfort/mine love mine all mine.jpeg",
  name: "Mine Love Mine All Mine",
  artist: "Mitski",
  audioPath: "assets/audio/songs/My Love Mine All Mine - Mitski.mp3"),

    Song( imgPath: "assets/images/bts songs/Answer love myself.jpeg",
  name: "Answer: Love Myself",
  artist: "BTS",
  audioPath: "assets/audio/songs/Answer _ Love Myself - BTS.mp3"),

   Song(imgPath: "assets/images/3rd row/comfort.jpeg",
  name: "Winter Bear",
  artist: "V",
  audioPath: "assets/audio/songs/Winter Bear - V.mp3"),

    Song(imgPath: "assets/images/sabrina carpenter img.jpeg",
  name: "Espresso",
  artist: "Sabrina Carpenter",
  audioPath: "assets/audio/songs/Espresso - Sabrina Carpenter.mp3"),

   Song(imgPath: "assets/images/taylor lover.jpeg",
  name: "Cruel Summer",
  artist: "Taylor Swift",
  audioPath: "assets/audio/songs/Cruel Summer - Taylor Swift.mp3"),

   Song(imgPath: "assets/images/comfort/double take.jpeg",
  name: "Double Take ",
  artist: "Dhruv",
  audioPath: "assets/audio/songs/double take - Dhruv.mp3"),

   Song(imgPath: "assets/images/comfort/pano.jpeg",
  name: "Pano",
  artist: "Zack Tabudlo",
              ...
              children: [
                ...
                Expanded(
                  child: ListView.builder(
                    ...
                    itemCount: weddingSongs.length,
                    itemBuilder: (_, index) {
                      final song = weddingSongs[index];
