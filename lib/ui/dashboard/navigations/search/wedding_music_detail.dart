...
class WeddingMusicDetail extends StatefulWidget {
  String AlbumPicPath = "assets/images/1st row/bts bts.jpeg";

  WeddingMusicDetail({required this.AlbumPicPath});

  @override
  State<WeddingMusicDetail> createState() => _AlbumDetailsPageState();
}

class _AlbumDetailsPageState extends State<WeddingMusicDetail> {
            ...
            child: Column(
              ...
              children: [
                const Padding(
                  ...
                  child: Text("Wedding Song Playlist",
